...
public interface ValueGrouping {
	...
	public class ValueGroupingFactory {
		...
		public static ValueGrouping getValueGrouping(GroupingType type, DataTableColumn dataTableColumn, boolean categorical, DateFormat dateFormat) throws ChartConfigurationException {
			...
			case EQUIDISTANT_FIXED_BIN_COUNT:
				return new EquidistantFixedBinCountBinning(binCount, Double.NaN, Double.NaN, dataTableColumn, categorical, dateFormat);
			case NONE:
				return null;
			default:
	...
	public enum GroupingType{
		...
		EQUIDISTANT_FIXED_BIN_COUNT(I18N.getGUILabel("plotter.grouping_type.EQUIDISTANT_FIXED_BIN_COUNT.label")),
		DISTINCT_VALUES(I18N.getGUILabel("plotter.grouping_type.DISTINCT_VALUES.label")),
		EQUAL_DATA_FRACTION(I18N.getGUILabel("plotter.grouping_type.EQUAL_DATA_FRACTION.label"));
