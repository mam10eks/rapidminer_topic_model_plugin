...
/**
 * <p>
 * This operator transposes an example set, i.e. the columns with become the new rows and the old rows will become the columns. Hence, this
 * operator works very similar to the well know transpose operation for matrices.
 * </p>
 * 
 * <p>
 * If an Id attribute is part of the given example set, the ids will become the names of the new attributes. The names of the old attributes
 * will be transformed into the id values of a new special Id attribute. Since no other &quot;special&quot; examples or data rows exist, all
 * other new attributes will be regular after the transformation. You can use the {@link ChangeAttributeRole} operator in order to change
 * one of these into a special type afterwards.
 * </p>
 * 
 * <p>
 * If all old attribute have the same value type, all new attributes will have this value type. Otherwise, the new value types will all be
 * &quot;nominal&quot; if at least one nominal attribute was part of the given example set and &quot;real&quot; if the types contained mixed
 * numbers.
 * </p>
 * 
 * <p>
