 ...
 * delivers fractions of the total count instead of absolute values.
 * E.g. {@link SumAggregationFunction} delivers [20, 50, 30] this function
 * would deliver [0.2, 0.5, 0.3]
 * 
 * @author Marco Boeck
 *
 */
