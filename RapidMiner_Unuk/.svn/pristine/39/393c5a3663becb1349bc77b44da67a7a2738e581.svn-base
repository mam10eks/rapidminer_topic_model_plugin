...
/**
 * A cell editor for cron expression parameters. Supports the direct
 * specification of cron expressions. Also provides a button which
 * starts a dialog to edit cron expressions.
 * 
 * @author Nils Woehler
 *
 */
