...
public interface PlotEngine {
	...
	/**
	 * @return errors from the engine, e.g. PlotConfiguration settings which are
	 * not supported by this engine and prevent the chart from being created.
	 */
	public List<PlotConfigurationError> getEngineErrors();

	/**
	 * @return errors from the engine, e.g. PlotConfiguration settings which are
	 * not supported by this engine, but still allow the the chart to be created.
	 */
