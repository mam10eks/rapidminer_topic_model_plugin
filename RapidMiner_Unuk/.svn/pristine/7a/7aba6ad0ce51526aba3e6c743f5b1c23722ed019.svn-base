...
public class LegendConfiguration implements Cloneable {
	...
	public enum LegendPosition {
		...
		BOTTOM(I18N.getGUILabel("plotter.legendposition.BOTTOM.label"), RectangleEdge.BOTTOM), 
		LEFT(I18N.getGUILabel("plotter.legendposition.LEFT.label"), RectangleEdge.LEFT), 
		RIGHT(I18N.getGUILabel("plotter.legendposition.RIGHT.label"), RectangleEdge.RIGHT),
	...
	private void fireShowDimensionTypeChanged() {
		fireLegendConfigurationChanged(new LegendConfigurationChangeEvent(this, showDimensionType, LegendConfigurationChangeType.SHOW_DIMENSION_TYPE));
	}
	...
	public void setLegendBackgroundColor(Color legendBackgroundColor) {
		...
		fireLegendConfigurationChanged(new LegendConfigurationChangeEvent(this, legendBackgroundColor, LegendConfigurationChangeType.BACKGROUND_COLOR));
	}
	...
	public void setLegendFrameColor(Color legendFrameColor) {
		...
		fireLegendConfigurationChanged(new LegendConfigurationChangeEvent(this, legendFrameColor, LegendConfigurationChangeType.FRAME_COLOR));
	}
	...
	public void setShowLegendFrame(boolean showLegendFrame) {
		...
		fireLegendConfigurationChanged(new LegendConfigurationChangeEvent(this, showLegendFrame, LegendConfigurationChangeType.SHOW_LEGEND_FRAME));
	}
