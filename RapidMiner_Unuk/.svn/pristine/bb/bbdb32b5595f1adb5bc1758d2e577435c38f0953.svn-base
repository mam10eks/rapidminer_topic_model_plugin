...
public class ValueSourceChangeEvent implements ConfigurationChangeEvent {
	...
	public enum ValueSourceChangeType {
		DATATABLE_COLUMN_MAP, AGGREGATION_FUNCTION_MAP,		// the aggregation function has been exchanged
		USES_GROUPING, SERIES_FORMAT_CHANGED,			// the series format of a value source has been changed or exchanged
