...
/**
 * 
 * This operator deletes the selected file. If the file doesn't exist and the corresponding checkbox is activated, an exception is thrown.
 * 
...
public class DeleteFileOperator extends Operator{
	...
	public List<ParameterType> getParameterTypes(){
		...
		types.add(new ParameterTypeBoolean(PARAMETER_NO_FILE_ERROR, "Determines whether an exception should be generated if the file is not found.", false, false));
