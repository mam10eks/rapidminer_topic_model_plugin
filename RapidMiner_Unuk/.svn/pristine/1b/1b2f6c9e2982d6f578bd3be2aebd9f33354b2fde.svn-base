 ...
 * The sort order is defined by a DataTableSortProvider.
 * 
...
public class SortedDataTableView extends AbstractDataTable implements DataTableListener {
	 ...
	 * 
	 * Creates a view onto this SortedDataTableView (i.e. this 
	 * SortedDataTableView won't get garbage collected as long as the sampled
