...
public class ManageZoomAction extends ResourceAction {
	...
	/**
	 * Creates a new {@link ResourceAction} which opens the manage zoom dialog
	 * when triggered. With its help, the user can precisely define the zoom/selection area.
	 * @param engine
	 */
