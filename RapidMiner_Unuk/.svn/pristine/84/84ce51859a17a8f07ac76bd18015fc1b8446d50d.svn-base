 ...
 *  file still exists when {@link #launchStarts()} is called, This class will ask the user whether
 *  they want to go into safe mode, which disables loading of all plugins.
 * 
