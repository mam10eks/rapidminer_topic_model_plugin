 ...
 * Every {@link PlotConfigurationChangeEvent} has a cloned source of its starting {@link PlotConfiguration}.
 * 
 * @author Nils Woehler
 *
 */
public class PlotConfigurationChangeEvent implements ConfigurationChangeEvent {
	...
	public PlotConfigurationChangeEvent(PlotConfiguration source, PlotConfigurationChangeType type, RangeAxisConfig rangeAxis, Integer index) {
		setSource(source);
		if ((type != PlotConfigurationChangeType.RANGE_AXIS_CONFIG_ADDED) && (type != PlotConfigurationChangeType.RANGE_AXIS_CONFIG_REMOVED)
	 ...
	 */
	public PlotConfigurationChangeEvent(PlotConfiguration source, PlotConfigurationChangeType type, PlotDimension dimension, DimensionConfig dimensionConfig) {
	...
	public PlotConfigurationChangeEvent(PlotConfiguration source, PlotConfigurationChangeType type, Color color) {
		setSource(source);
		this.type = type;
		if ((type != PlotConfigurationChangeType.FRAME_BACKGROUND_COLOR) && (type != PlotConfigurationChangeType.PLOT_BACKGROUND_COLOR)
