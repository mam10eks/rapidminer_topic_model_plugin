...
/**
 * A value range which holds a list of other value ranges. If one range in that list
 * accepts a row, also this value range accepts the row.
 * 
 * @author Marius Helf
 *
 */
public class AggregatedValueRange extends AbstractValueRange {
	...
	/**
	 * Returns getValue() from the first subRange in the list of sub ranges,
	...
	/**
	 * Returns the result of definesUpperLowerBound() on the first subrange, or
	...
	/**
	 * Returns the upper bound of the first sub range if applicable, or
	...
	/**
	 * Returns the lower bound of the first sub range if applicable, or
	 * Double.NaN otherwise.
	 * 
