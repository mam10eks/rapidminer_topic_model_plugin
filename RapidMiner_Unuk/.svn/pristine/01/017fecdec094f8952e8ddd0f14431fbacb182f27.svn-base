...
public class DimensionConfigChangeEvent implements ConfigurationChangeEvent {
	...
	/**
	 * Allowed {@link DimensionConfigChangeType}s are ABOUT_TO_CHANGE_GROUPING or RESET or COLOR_SCHEME
	 */
	public DimensionConfigChangeEvent(DimensionConfig source, PlotDimension dimension, DimensionConfigChangeType type) {
		if((type != DimensionConfigChangeType.ABOUT_TO_CHANGE_GROUPING)
				&& (type != DimensionConfigChangeType.RESET)
	...
	public DimensionConfigChangeEvent(DimensionConfig source, PlotDimension dimension, ValueGroupingChangeEvent groupingChangeEvent) {
		this.source = source;
	...
	public DimensionConfigChangeEvent(DimensionConfig source, PlotDimension dimension, ValueRangeChangeEvent valueRangeChangedEvent) {
		this.source = source;
	...
	public DimensionConfigChangeEvent(DimensionConfig source, PlotDimension dimension, Boolean bool, DimensionConfigChangeType type) {
		if((type != DimensionConfigChangeType.SCALING)
				&& (type != DimensionConfigChangeType.AUTO_NAMING)) {
			throw new RuntimeException(type+" is not allowed calling this constructor.");
		}
		this.source = source;
		this.type = type;
	...
	public DimensionConfigChangeEvent(DimensionConfig source, PlotDimension dimension, DomainConfigManager.Sorting sortingMode) {
		this.source = source;
	...
	public DimensionConfigChangeEvent(DomainConfigManager source, PlotDimension dimension, AxisParallelLinesConfigurationChangeEvent e) {
