...
public class GroupCellData {
	 ...
	 * All other usage types should have the same number of values.
	 */
	public int getSize() {
	 ...
	 * Each double array is initialized with size valueCount.
	 * 
	 * The created map is added to this GroupCellData and then returned to the caller.
	 */
	public Map<PlotDimension,double[]> initDataForUsageType(SeriesUsageType usageType, Iterable<PlotDimension> dimensions, int valueCount) {
