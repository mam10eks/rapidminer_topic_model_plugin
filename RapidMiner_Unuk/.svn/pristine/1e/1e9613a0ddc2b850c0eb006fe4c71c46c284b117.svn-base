...
/**
 * Interface for value ranges. A value range is a collection of values. How these
 * are specified depends on the implementation. Possibilities are: a single value,
 * a list of discrete or nominal values, or a value range with x <= value <= y.
 * 
