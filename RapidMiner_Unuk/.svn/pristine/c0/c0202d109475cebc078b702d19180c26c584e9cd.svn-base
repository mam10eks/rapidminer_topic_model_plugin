 ...
 * All available templates for specific plot types must be registered here.
 * 
 * @author Marco Boeck
 *
 */
public class TemplateChooser {
	 ...
	 * @param dataSetName the identifying name of the new data
	 * @param exampleSet the new data
	 */
