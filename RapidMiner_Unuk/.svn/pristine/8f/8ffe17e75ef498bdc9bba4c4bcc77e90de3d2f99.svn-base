...
public class FilteredDataTable extends DataTableView {
	...
	/**
	 * Adds a batch of conditions. The listeners will be only informed after all
	 * of the conditions have been added. Null conditions will be ignored.
	 * 
	...
	/**
	 * @return a vector which contains the indices of all rows in the parent table that match the condition stack.
	 */
