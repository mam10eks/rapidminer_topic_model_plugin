	...
	private void createComponents() {
...

		{
...

			{
				...
				// create font list
				fontList = new JList(GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames(Locale.getDefault()));
...

			{
				...
				previewLabel = new JLabel("ABCDEFG abcdefg", JLabel.CENTER);
