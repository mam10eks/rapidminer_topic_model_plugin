...
//			System.err.println(new java.sql.Timestamp(new java.util.Date().getTime())+ " #Thread ID:" + Thread.currentThread().getId() + "# " + message + " ");
//		} else {
//			System.out.println(new java.sql.Timestamp(new java.util.Date().getTime()) + " #Thread ID:" + Thread.currentThread().getId() + "# " + message + " ");
//		}
	}
...
//		System.out.println(new java.sql.Timestamp(new java.util.Date().getTime()) + " " + value.toString() + " ");
	}
