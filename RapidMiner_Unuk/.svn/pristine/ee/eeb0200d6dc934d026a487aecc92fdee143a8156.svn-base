...
/**
 * This class is a view on a DataTable which hides all examples not listed
 * in an index list.
 * 
...
public class DataTableView extends AbstractDataTable implements DataTableListener {
	 ...
	 * If newSize is greater than the size of this DataTableView,
	 * this DataTableView is returned.
	 * 
	 * Creates a view onto this DataTableView (i.e. the this DataTableView 
	 * won't get garbage collected as long as the sampled
	 * DataTableView is around.)
	 */
	@Override
	public DataTable sample(int newSize) {
		...
		// convert prefix of sampled indices to vector and set as selected indices for sampled data table view
	 ...
	 * Anything else is not possible since there does not exist any rule
	 * how to update the view.
	 * 
	 * Subclasses like {@link FilteredDataTable} should implement a smarter
