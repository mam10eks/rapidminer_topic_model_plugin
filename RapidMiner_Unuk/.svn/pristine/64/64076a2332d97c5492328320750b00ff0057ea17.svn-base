...
public class SeriesMultipleTemplatePanel extends PlotterTemplatePanel implements Observer {
		...
		this.updatePlotListSelectionListener = new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				if (!e.getValueIsAdjusting()) {
					SeriesMultipleTemplatePanel.this.seriesMultipleTemplate.setPlotSelection(plotSeriesList.getSelectedValues());
                }
			}
		};
		setupGUI();
	...
	private void setupGUI() {
		...
		JLabel indexDimensionLabel = new JLabel(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.series_multiple.index_dimension.column.label"));
		indexDimensionLabel.setToolTipText(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.series_multiple.index_dimension.column.tip"));
		...
		indexDimensionComboBox.setToolTipText(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.series_multiple.index_dimension.column.tip"));
		gbc.insets = new Insets(2, 5, 2, 5);
		gbc.gridx = 0;
		gbc.gridy = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
