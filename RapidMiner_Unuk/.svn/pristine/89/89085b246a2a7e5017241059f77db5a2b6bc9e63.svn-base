...
public class ListUtility {
	 ...
	 * shifted left.
	 * <b>
	 * If size of list is one or the old index equals the new index, no changes will commence.
	 * Returns <code>true</code> if changes have been performed, <code>false</code> otherwise.
	 */
