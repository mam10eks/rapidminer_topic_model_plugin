...
public class SingleValueValueRange extends AbstractValueRange {
	 ...
	 * 
	 * @param value the value of the value range
	 * @param valueString a string representation of the value, which will be used in the {@link #toString()} method. If null, 
	 * 		a value string is created based on the 
	 ...
	 * @throws IllegalArgumentException if the specified column has an unknown data type 
	 * 		(i.e. neither numerical, nominal nor date).
	 */
	...
	/**
	 * Instantiates a new {@link SingleValueValueRange}. Value is considered to represent a date
	 * and is formatted with the provided {@link DateFormat}.
	 * 
	 * @param value the value of the value range
