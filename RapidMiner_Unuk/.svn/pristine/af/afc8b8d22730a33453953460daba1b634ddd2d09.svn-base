...
public class LineChartConfigurationPanel extends AbstractTreeSelectionDependentPanel {
	...
	private void createComponents(boolean smallIcons) {
			...
			itemShapeComboBox.addPopupMenuListener(new PopupMenuListener() {
				...
				public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
					if (getSelectedValueSource() != null) {
						getSelectedValueSource().getSeriesFormat().setItemShape((ItemShape) itemShapeComboBox.getSelectedItem());
					}
				}
		...
		//			lineColorButton = (new ResourceAction(smallIcons, "plotter.configuration_dialog.choose_color") {
		//
		//				private static final long	serialVersionUID	= 1L;
		//
		//				@Override
...

		{
			...
			itemFillComboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					if (getSelectedValueSource() != null) {
						getSelectedValueSource().getSeriesFormat().setAreaFillStyle((FillStyle) itemFillComboBox.getSelectedItem());
					}
				}
			});
	...
	private void createItemColorDialog() {
		if (getSelectedValueSource() != null) {
			...
			Color newItemColor = JColorChooser.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.choose_color.label"), itemColor);
	...
	//			Color newLineColor = JColorChooser.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.choose_color.label"), lineColor); 
