...
public class UsageStatsTransmissionDialog extends ButtonDialog {
	...
	private static final long MIN_FIRE_INTERVAL = 1000 * 60 * 60 * 24 * 2;
							...
							try {
								...
								LogService.getRoot().log(
										...
										I18N.getMessage(LogService.getRoot().getResourceBundle(),
												"com.rapidminer.tools.usagestats.UsageStatsTransmissionDialog.submitting_operator_usage_statistics_error"), e);
								UsageStatistics.getInstance().scheduleTransmission(true);
							}
