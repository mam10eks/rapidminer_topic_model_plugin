	...
	private void createComponents(boolean smallIcons) {
        ...
        // add fillstyle
		{
			...
			fillStyleComboBox.addPopupMenuListener(new PopupMenuListener() {
				...
				public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
					getSelectedValueSource().getSeriesFormat().setAreaFillStyle((FillStyle) fillStyleComboBox.getSelectedItem());
		...
		
		{
			...
			stackingModeComboBox.addPopupMenuListener(new PopupMenuListener() {
				...
				@Override
				public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
					getSelectedValueSource().getSeriesFormat().setStackingMode((StackingMode) stackingModeComboBox.getSelectedItem());
