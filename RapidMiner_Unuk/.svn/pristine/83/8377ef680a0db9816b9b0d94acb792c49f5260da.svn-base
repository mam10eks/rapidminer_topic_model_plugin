            ...
            if (!attribute.equals(indexAttribute)) {
                if ((skipConstantAttributes && constantAttributeValues[i]) || attribute.equals(groupAttribute)) {
                    ...
                    for (String indexValue : indexValues) {
                        ...
                        Attribute newAttribute = AttributeFactory.createAttribute(newAttributeName, attribute.getValueType());
                ...
                if (newIndex != -1) {
                    ...
                    if (Double.isNaN(value)) {
                    	...
                    	if (attribute.isNominal()) {
                    		dataRow.set(newAttribute, newAttribute.getMapping().mapString(attribute.getMapping().mapIndex((int) value)));
                    	} else {
