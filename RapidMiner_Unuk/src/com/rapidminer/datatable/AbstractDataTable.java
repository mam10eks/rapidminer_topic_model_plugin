...
public abstract class AbstractDataTable implements DataTable, Tableable {
	...
	private List<WeakReference<DataTableListener>> weakReferencedListeners = new LinkedList<WeakReference<DataTableListener>>();
	...
	public void addDataTableListener(DataTableListener dataTableListener, boolean weakReference) {
		if (weakReference) {
			this.weakReferencedListeners.add(new WeakReference<DataTableListener>(dataTableListener));
		} else {
	...
	protected void fireEvent() {
		...
		List<WeakReference<DataTableListener>> clone = new LinkedList<WeakReference<DataTableListener>>(weakReferencedListeners);
