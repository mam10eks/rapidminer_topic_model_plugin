...
public class FrequentItemSetsToData extends Operator {
	...
	public FrequentItemSetsToData(OperatorDescription description) {
		...
		getTransformer().addRule(new GenerateNewExampleSetMDRule(exampleSetOutput) {
			...
			public MetaData modifyMetaData(ExampleSetMetaData emd) {
				...
				emd.addAttribute(new AttributeMetaData("Size", null, Ontology.INTEGER, new Range(0, Double.POSITIVE_INFINITY)));
				emd.addAttribute(new AttributeMetaData("Frequency", null, Ontology.INTEGER, new Range(0, Double.POSITIVE_INFINITY)));
				emd.addAttribute(new AttributeMetaData("Support", null, Ontology.REAL, new Range(0, 1)));
				emd.addAttribute(new AttributeMetaData("Score", null, Ontology.REAL, new Range(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY)));
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeBoolean(PARAMETER_GENERATE_ITEM_SET_INDICATORS, "Determines whether item indicator attributes should be generated for the item sets.", false));
