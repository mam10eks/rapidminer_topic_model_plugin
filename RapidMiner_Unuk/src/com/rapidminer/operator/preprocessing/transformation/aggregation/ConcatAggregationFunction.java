...
public class ConcatAggregationFunction extends NominalAggregationFunction {
    ...
    public ConcatAggregationFunction(Attribute sourceAttribute, boolean ignoreMissings, boolean countOnlyDisctinct) {
        super(sourceAttribute, ignoreMissings, countOnlyDisctinct, FUNCTION_CONCAT, FUNCTION_SEPARATOR_OPEN, FUNCTION_SEPARATOR_CLOSE);
    }

    public ConcatAggregationFunction(Attribute sourceAttribute, boolean ignoreMissings,boolean countOnlyDisctinct,  String functionName, String separatorOpen, String separatorClose) {
