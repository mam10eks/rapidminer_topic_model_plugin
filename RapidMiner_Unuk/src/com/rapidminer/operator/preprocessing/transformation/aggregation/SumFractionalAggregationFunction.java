...
/**
 * This function first behaves like {@link SumAggregationFunction}, but it
 * delivers fractions of the total sum instead of absolute values.
 * E.g. {@link SumAggregationFunction} delivers [6, 10, 4] this function
 * would deliver [0.3, 0.5, 0.2]
 * 
 * @author Marius Helf
 *
 */
public class SumFractionalAggregationFunction extends SumAggregationFunction {
	...
	public SumFractionalAggregationFunction(Attribute sourceAttribute, boolean ignoreMissings, boolean countOnlyDisctinct) {
		super(sourceAttribute, ignoreMissings, countOnlyDisctinct, FUNCTION_SUM_FRACTIONAL, FUNCTION_SEPARATOR_OPEN, FUNCTION_SEPARATOR_CLOSE);
	}

	public SumFractionalAggregationFunction(Attribute sourceAttribute, boolean ignoreMissings, boolean countOnlyDisctinct, String functionName,
