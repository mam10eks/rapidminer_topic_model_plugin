...
/**
 * This operator creates a new example set from the given performance vector. 
 * The example set will have a column with the criterion name, and columns for
...
//				AttributeMetaData exampleCountAMD = new AttributeMetaData(ATTRIBUTE_EXAMPLE_COUNT, Ontology.REAL);
