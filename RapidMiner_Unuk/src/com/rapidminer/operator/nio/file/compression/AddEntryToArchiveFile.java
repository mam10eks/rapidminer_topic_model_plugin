...
/**
 * An operator which adds one or more files to an archive file.
 * Archive files are files like zip files etc.
 * 
 * @author Marius Helf
 *
 */
public class AddEntryToArchiveFile extends Operator {
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeString(PARAMETER_DIRECTORY, "This parameter specifies the directory where the entry will be stored inside the archive file. Specify it in the form 'my/sub/directory', or leave it empty to store the entry in the root folder.", "", false));
		...
		ParameterType type = new ParameterTypeCategory(PARAMETER_COMPRESSION_LEVEL, "The compression level of the newly created entries is specified through this parameter.	In general, higher compression levels result also in a higher runtime.", COMPRESSION_LEVELS, COMPRESSION_LEVEL_DEFAULT, true);
