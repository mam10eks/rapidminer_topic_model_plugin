...
public class DataToAnnotations extends Operator {
	...
	public DataToAnnotations(OperatorDescription description) {
		...
		annotationsInputPort.addPrecondition(new AttributeSetPrecondition(annotationsInputPort, AttributeSetPrecondition.getAttributesByParameter(this, PARAMETER_KEY_ATTRIBUTE)));
		annotationsInputPort.addPrecondition(new AttributeSetPrecondition(annotationsInputPort, AttributeSetPrecondition.getAttributesByParameter(this, PARAMETER_VALUE_ATTRIBUTE)));
	}
	...
	public void doWork() throws OperatorException {
		...
		if (keyAttribute == null) {
			throw new UserError(this, 111, keyAttributeName);
		} else if (valueAttribute == null) {
			throw new UserError(this, 111, valueAttributeName);
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeAttribute(PARAMETER_KEY_ATTRIBUTE, "The attribute which contains the names of the annotations to be created. Should be unique.", annotationsInputPort, false, false, Ontology.NOMINAL));
		types.add(new ParameterTypeAttribute(PARAMETER_VALUE_ATTRIBUTE, "The attribute which contains the values of the annotations to be created. If a value is missing, the respective annotation will be removed.", annotationsInputPort, false, false, Ontology.NOMINAL));
