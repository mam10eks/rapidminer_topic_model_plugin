...
/**
 * A parameter type for ordering rules of attributes. 
 * This parameter type has been introduced to allow a different cell rendered for this class.
 * 
 * @author Nils Woehler
 */
public class ParameterTypeAttributeOrderingRules extends ParameterTypeAttribute {
	...
	public ParameterTypeAttributeOrderingRules(final String key, String description, InputPort inPort, boolean optional, int... valueTypes) {
		super(key, description, inPort, optional, valueTypes);
	}

	public ParameterTypeAttributeOrderingRules(final String key, String description, InputPort inPort, boolean optional, boolean expert) {
