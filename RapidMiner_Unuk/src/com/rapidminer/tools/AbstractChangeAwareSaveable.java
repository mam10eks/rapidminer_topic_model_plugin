...
/**
 * @param the argument that is expected when observing other classes
 * 
 * @author Nils Woehler
 *
 */
public abstract class AbstractChangeAwareSaveable<O> extends AbstractObservable<ChangeAwareSaveable> implements ChangeAwareSaveable {
	...
	private DelegatingObserver<O, ChangeAwareSaveable> delegatingObserver = new DelegatingObserver<O, ChangeAwareSaveable>(this, this);
