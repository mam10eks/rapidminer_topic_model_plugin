...
public interface AggregationFunction {
	...
	/**
	 * Returns whether this function supports attributes of the given type, where
	 * valueType is one of the static value types defined in {@link Ontology}. 
	 */
	public boolean supportsValueType(int valueType);
	
	/**
	 * Returns the result type of this {@link AggregationFunction} when applied on data of type inputType
	 * as one of the static value types defined in {@link Ontology}.
	 */
