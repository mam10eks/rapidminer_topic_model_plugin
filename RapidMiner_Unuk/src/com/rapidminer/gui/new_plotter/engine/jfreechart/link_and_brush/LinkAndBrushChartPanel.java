...
//                this.chartBufferHeight = (int) available.getHeight();
                ...
                setChartFieldValue(getChartFieldByName("chartBuffer"), gc.createCompatibleImage((Integer) getChartFieldValueByName("chartBufferWidth"), (Integer) getChartFieldValueByName("chartBufferHeight"), Transparency.TRANSLUCENT));
//                this.chartBuffer = gc.createCompatibleImage(this.chartBufferWidth, this.chartBufferHeight, Transparency.TRANSLUCENT);
            ...
            if (getRefreshBuffer()) {
                ...
                Rectangle2D bufferArea = new Rectangle2D.Double(
                        0, 0, (Integer) getChartFieldValueByName("chartBufferWidth"), (Integer) getChartFieldValueByName("chartBufferHeight"));

                Graphics2D bufferG2 = (Graphics2D)(
                        (Image) getChartFieldValueByName("chartBuffer")).getGraphics();
                ...
                if (scale) {
                    ...
                    AffineTransform st = AffineTransform.getScaleInstance(
                    		(Double) getChartFieldValueByName("scaleX"), (Double) getChartFieldValueByName("scaleY"));
                    bufferG2.transform(st);
                    getChart().draw(bufferG2, chartArea, getAnchor(),
                            getChartRenderingInfo());
                    bufferG2.setTransform(saved);
                }
                else {
                    getChart().draw(bufferG2, bufferArea, getAnchor(),
                            getChartRenderingInfo());
                }
	...
	public void mouseDragged(MouseEvent e) {
        ...
        if (hZoom && vZoom) {
            ...
            setChartFieldValue(getChartFieldByName("zoomRectangle"), new Rectangle2D.Double(
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (getChartFieldValueByName("panLast") != null) {
            ...
            boolean zoomTrigger1 = hZoom && Math.abs(e.getX()
                - zoomPoint.getX()) >= (Integer) getChartFieldValueByName("zoomTriggerDistance");
            boolean zoomTrigger2 = vZoom && Math.abs(e.getY()
                - zoomPoint.getY()) >= (Integer) getChartFieldValueByName("zoomTriggerDistance");
	...
	/**
	 * Add a {@link LinkAndBrushSelectionListener}.
	 * The listener is saved as a {@link WeakReference}. Thus listener must not be hidden (anonymous) classes!
	 */
	...
	/**
	 * Returns the value of a {@link Field} of the {@link ChartPanel}.
	 * If the field can not be found, returns {@code null}.
	...
	/**
	 * Returns the {@link Field} of the {@link ChartPanel}.
	 * If the field can not be found, returns {@code null}.
	 * @param name the name of the {@link Field}
	 * @return
	 */
	 ...
	 * @param field the {@link Field} to change
	 * @param value the new value for the {@link Field}
	 */
