 ...
 * @author Marius Helf
 */
public class FormattedXYErrorRenderer extends XYErrorRenderer implements FormattedRenderer, RenderFormatDelegateChangeListener {
	...
	public void renderFormatDelegateChanged(RenderFormatDelegate source) {
		...
		if (seriesFormat != null) {
			setErrorStroke(new BasicStroke(Math.round(seriesFormat.getLineWidth()/2.0), BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER));
		}
	}
