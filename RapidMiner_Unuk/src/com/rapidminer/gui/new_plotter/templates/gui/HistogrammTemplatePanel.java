...
//		rotateLabelsCheckBox = new JCheckBox(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.histogram.rotate_labels.label"));
//		rotateLabelsCheckBox.setToolTipText(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.histogram.rotate_labels.tip"));
...
//		this.add(rotateLabelsCheckBox, gbc);
		...
		binsSlider.setToolTipText(I18N.getMessage(I18N.getGUIBundle(), "gui.plotter.histogram.bins.tip", binsSlider.getValue()));
