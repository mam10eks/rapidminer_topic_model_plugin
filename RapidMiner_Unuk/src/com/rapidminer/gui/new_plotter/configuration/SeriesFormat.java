...
//		      return p0;
	...
	public enum ItemShape {
		...
		CIRCLE(ItemShapeFactory.createCircle(),I18N.getGUILabel("plotter.dotstyle.CIRCLE.label")),
		SQUARE(ItemShapeFactory.createSquare(), I18N.getGUILabel("plotter.dotstyle.SQUARE.label")),
		DIAMOND(ItemShapeFactory.createDiamond(),I18N.getGUILabel("plotter.dotstyle.DIAMOND.label")),
		TRIANGLE(ItemShapeFactory.createTriangular(),I18N.getGUILabel("plotter.dotstyle.TRIANGLE.label")),
		TRIANGLE_UPSIDE_DOWN(ItemShapeFactory.createTurnedTriangular(),I18N.getGUILabel("plotter.dotstyle.TRIANGLE_UPSIDE_DOWN.label")),
		STAR(ItemShapeFactory.createStar(),I18N.getGUILabel("plotter.dotstyle.STAR.label")),
		HOURGLASS(ItemShapeFactory.createHourglass(),I18N.getGUILabel("plotter.dotstyle.HOURGLASS.label")),
		CROSSHAIRS(ItemShapeFactory.createCrosshairs(),I18N.getGUILabel("plotter.dotstyle.CROSSHAIRS.label")),
		;
	...
	public enum IndicatorType {
		...
		DIFFERENCE(I18N.getGUILabel("plotter.error_indicator.DIFFERENCE.label")),
		;
	...
	public enum FillStyle {
		...
		CROSS_HATCHED(I18N.getGUILabel("plotter.fillstyle.CROSS_HATCHED.label")), 
		RISING_HATCHED(I18N.getGUILabel("plotter.fillstyle.RISING_HATCHED.label")), 
		FALLING_HATCHED(I18N.getGUILabel("plotter.fillstyle.FALLING_HATCHED.label")), 
		VERTICALLY_HATCHED(I18N.getGUILabel("plotter.fillstyle.VERTICALLY_HATCHED.label")), 
		HORIZONTALLY_HATCHED(I18N.getGUILabel("plotter.fillstyle.HORIZONTALLY_HATCHED.label"));
	...
	public enum StackingMode {
		...
		RELATIVE(I18N.getGUILabel("plotter.stacking_mode.percentage"));
	...
	/**
	 * Sets the item color to itemColor. The alpha value of itemColor is ignored, instead
	 * the opacity property of this SeriesFormat is applied.
	 */
...
//			g2.fillRect(0, 0, 10, 10);
	...
	/**
	 * Returns true iff the attribute XYZ to which the dimension refers (e.g. color for Color dimension,
	 * shape for Shape dimension) is to be calculated individually for each item using the XYZProvider of
	 * dimensionConfig.
	 * If this function returns false, the respective attribute is set globally for the whole series.  
	 */
	...
	/**
	 * Returns true iff the attribute XYZ to which the dimension refers (e.g. color for Color dimension,
	 * shape for Shape dimension) is to be calculated individually for each series of a value source using the XYZProvider of
	 * dimensionConfig.
	 * If this function returns false, the respective attribute is set globally for the whole value source.  
	 */
