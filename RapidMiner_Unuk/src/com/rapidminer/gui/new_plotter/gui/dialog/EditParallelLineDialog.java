...
/**
 * This dialog allows the user to edit a {@link AxisParallelLineConfiguration} line (crosshair line).
 * 
 * @author Marco Boeck
 * 
 */
public class EditParallelLineDialog extends JDialog {
	...
	private void setupGUI() {
		...
		gbc.fill = GridBagConstraints.NONE;
		gbc.weightx = 0;
		JLabel styleLabel = new JLabel(I18N.getMessage(I18N.getGUIBundle(), "gui.action.edit_parallel_line.line_style.label"));
		...
		okButton.setIcon(SwingTools.createIcon("24/" + I18N.getMessage(I18N.getGUIBundle(), "gui.action.edit_parallel_line.ok.icon")));
		...
		cancelButton.setIcon(SwingTools.createIcon("24/" + I18N.getMessage(I18N.getGUIBundle(), "gui.action.edit_parallel_line.cancel.icon")));
		cancelButton.setMnemonic(I18N.getMessage(I18N.getGUIBundle(), "gui.action.edit_parallel_line.cancel.mne").toCharArray()[0]);
	...
	private void createLineColorDialog() {
		...
		Color newLineColor = JColorChooser.showDialog(null, I18N.getGUILabel("edit_parallel_line.line_color_title.label"), oldColor);
