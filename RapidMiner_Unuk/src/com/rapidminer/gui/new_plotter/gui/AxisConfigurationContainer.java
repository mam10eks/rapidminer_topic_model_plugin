...
public class AxisConfigurationContainer extends AbstractConfigurationPanel {
	...
	private void createComponents() {
		...
		{
			JLabel domainAxisLineColorLabel = new ResourceLabel("plotter.configuration_dialog.global_config_panel.axis_color");

			domainAxisLineColorChooserButton = new JButton(new ResourceAction(true, "plotter.configuration_dialog.global_config_panel.axis_color") {
	...
	private void createDomainAxisColorDialog() {
		...
		Color newLineColor = JColorChooser.showDialog(this,
				I18N.getGUILabel("plotter.configuration_dialog.global_config_panel.plot_background_color_title.label"), oldColor);
