...
public class GlobalConfigurationPanel extends AbstractConfigurationPanel {
	...
	private void createComponents() {
		...
		// add legend popup button
		{
			...
			JToggleButton legendStyleConfigButton = new JToggleButton(new PopupAction(true, "plotter.configuration_dialog.open_popup", legendConfigContainer,
		...
		// add legend popup button
		{
			...
			JToggleButton axisStyleConfigureButton = new JToggleButton(new PopupAction(true, "plotter.configuration_dialog.open_popup", axisConfigurationContainer,
					PopupAction.PopupPosition.HORIZONTAL));
...
//			this.add(frameBackgroundColorChooserButton, itemConstraint);
	...
	private void startAnimation() {
		...
		//		DefaultValueSource valueSource = new DefaultValueSource(plotConfig, mainColumn, null, false);
		//		try {
		...
		//
		//		DefaultDimensionConfig colorDimension = new DefaultDimensionConfig(plotConfig, mainColumn, PlotDimension.COLOR);
	...
	private void createFrameBackgroundColorDialog() {
		...
		Color newBackgroundColor = JColorChooser
				.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.global_config_panel.chart_background_color_title.label"), oldColor);
		if (newBackgroundColor != null && !(newBackgroundColor.equals(oldColor))) {
