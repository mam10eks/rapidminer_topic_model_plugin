...
public class LegendConfigurationPanel extends AbstractConfigurationPanel {
	...
	private void createComponents() {
		{
			...
			legendPositionComboBox.addPopupMenuListener(new PopupMenuListener() {
				...
				public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
					getPlotConfiguration().getLegendConfiguration().setLegendPosition((LegendPosition) legendPositionComboBox.getSelectedItem());
				}
		...
		{
			legendFontColorLabel = new ResourceLabel("plotter.configuration_dialog.legend_color_dialog.select_legend_font_color");

			legendFontColorChooserButton = new JButton(new ResourceAction(true, "plotter.configuration_dialog.select_legend_font_color") {
		...
		// create show dimension type row
		{
			...
			showDimensionTypeCheckBox.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					getPlotConfiguration().getLegendConfiguration().setShowDimensionType(showDimensionTypeCheckBox.isSelected());
				}
			});
		...
		{
			legendBackGroundColorLabel = new ResourceLabel("plotter.configuration_dialog.legend_color_dialog.select_legend_background_color"); 

			legendBackgroundColorChooserButton = new JButton(new ResourceAction(true, "plotter.configuration_dialog.select_legend_background_color") { 
		...
		{
			legendFrameColorLabel = new ResourceLabel("plotter.configuration_dialog.legend_color_dialog.select_legend_frame_color"); 
 
			legendFrameColorChooserButton = new JButton(new ResourceAction(true, "plotter.configuration_dialog.select_legend_frame_color") { 
	...
	private void createLegendBackgroundColorDialog() {
		...
		Color newBackgroundColor = JColorChooser.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.global_config_panel.legend_background_color_title.label"), oldColor);  
	...
	private void createLegendFontColorDialog() {
		...
		Color newBackgroundColor = JColorChooser.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.global_config_panel.legend_font_color_title.label"), oldColor); 
		if (newBackgroundColor != null && !(newBackgroundColor.equals(oldColor))) {
	...
	private void createLegendFrameColorDialog() {
		...
		Color newBackgroundColor = JColorChooser.showDialog(this, I18N.getGUILabel("plotter.configuration_dialog.global_config_panel.legend_frame_color_title.label"), oldColor); 
		if (newBackgroundColor != null && !(newBackgroundColor.equals(oldColor))) {
