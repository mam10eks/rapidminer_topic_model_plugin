...
public class RangeAxisConfigPanel extends AbstractConfigurationPanel implements TreeSelectionListener {
	...
	private void createComponents() {
		...
		//		{
		//			JLabel automateLabel = new ResourceLabel("plotter.configuration_dialog.automatic_axis_label");
		//
	...
	public void valueChanged(TreeSelectionEvent e) {
		...
		if (lastPathComponent instanceof RangeAxisConfigTreeNode) {
			...
			RangeAxisConfig selectedConfig = (RangeAxisConfig) ((RangeAxisConfigTreeNode) lastPathComponent).getUserObject();
