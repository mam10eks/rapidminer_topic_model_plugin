...
public class AxisParallelLineConfigurationChangeEvent {
	...
	public AxisParallelLineConfigurationChangeEvent(AxisParallelLineConfiguration axisParallelLineConfiguration, LineFormatChangeEvent e) {
		this.type = AxisParallelLineConfigurationChangeType.FORMAT;
		this.source = axisParallelLineConfiguration;
		this.lineFormatChange = e; 
	}

	public AxisParallelLineConfigurationChangeEvent(AxisParallelLineConfiguration axisParallelLineConfiguration, boolean labelVisible) {
		this.source = axisParallelLineConfiguration;
