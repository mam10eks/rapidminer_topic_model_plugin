...
public class AttributeOrderingDialog extends PropertyDialog {
	...
	public AttributeOrderingDialog(final ParameterTypeAttributeOrderingRules type, Collection<String> preselectedItems, boolean useRegExp) {
		...
		attributeListPanel.setBorder(createTitledBorder(I18N.getMessage(I18N.getGUIBundle(), getKey() + ".attributes.border")));
		...
		selectedRulesListPanel.setBorder(createTitledBorder(I18N.getMessage(I18N.getGUIBundle(), getKey() + ".selected_attributes.border")));
